...
class RobotActionController(Node):
    def __init__(self):
        ...
        # Keep topic names consistent with online_eval_uninavid.py and existing ROS graph.
        # These resolve to /sign and /cmd_vel in the default namespace.
        self.subscription = self.create_subscription(String, 'sign', self.listener_callback, 10)
